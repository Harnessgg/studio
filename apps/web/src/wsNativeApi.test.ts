...
describe("wsNativeApi", () => {
  it("delivers and caches valid server.welcome payloads", async () => {
    ...
    const payload = { cwd: "/tmp/workspace", projectName: "studio-code" };
  ...
  it("delivers successive server.welcome payloads to active listeners", async () => {
    ...
    emitPush(WS_CHANNELS.serverWelcome, { cwd: "/tmp/workspace", projectName: "studio-code" });
