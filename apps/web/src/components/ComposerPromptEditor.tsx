...
class ComposerMentionNode extends TextNode {
  ...
  override createDOM(_config: EditorConfig): HTMLElement {
    ...
    dom.className =
      "inline-flex select-none items-center gap-1 rounded-md border border-border/70 bg-accent/40 px-1.5 py-px font-medium text-xs leading-[1.1] text-foreground align-middle";
