...
export default function Sidebar() {
  ...
  const handleProjectNewThreadClick = useCallback(
  ...
  const wordmark = (
    <div className="flex items-center gap-2">
      ...
      <Tooltip>
        <TooltipTrigger
          render={
            <div className="mt-1 ml-1 flex min-w-0 flex-1 items-start gap-2 cursor-pointer">
              <div className="flex min-w-0 flex-1 flex-col items-start leading-none">
                ...
                <span className="truncate pl-[1.55rem] pt-0.5 text-[10px] font-medium tracking-[0.02em] text-muted-foreground/70">
                  by HarnessGG
                </span>
              </div>
              {APP_STAGE_LABEL ? (
        ...
        <SidebarGroup className="px-2 py-2">
          <div className="mb-1 flex items-center justify-between px-2">
            ...
            <Tooltip>
              ...
              <TooltipPopup side="right">Add video project</TooltipPopup>
            </Tooltip>
          </div>
            ...
            <div className="mb-2 px-1">
              {isElectron && (
                ...
                >
                  ...
                  {isPickingFolder ? "Picking folder..." : "Choose folder"}
                </button>
              )}
              <div className="flex gap-1.5">
                <input
                  ...
                  placeholder="/path/to/video-project"
                  value={newCwd}
                  onChange={(event) => {
                            ...
                            <Tooltip>
                                ...
                                render={
                                  <SidebarMenuAction
                                    render={
                                      <button
                                        type="button"
                                        aria-label={`Create new edit session in ${project.name}`}
                                    ...
                                    onClick={(event) => {
                                      handleProjectNewThreadClick(event, project.id);
                                    }}
                                  >
                              ...
                              <TooltipPopup side="top">
                                {newThreadShortcutLabel
                                  ? `New edit session (${newThreadShortcutLabel})`
                                  : "New edit session"}
                              </TooltipPopup>
                            </Tooltip>
                          </div>
