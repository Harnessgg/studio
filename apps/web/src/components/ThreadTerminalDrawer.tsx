...
function terminalThemeFromApp(): ITheme {
  ...
  return {
    background: read("--terminal-background", "rgb(30, 40, 48)"),
    foreground: read("--terminal-foreground", "rgb(215, 226, 232)"),
    cursor: read("--terminal-cursor", "rgb(169, 195, 209)"),
    selectionBackground: read("--terminal-selection", "rgba(122, 154, 170, 0.28)"),
    scrollbarSliderBackground: read("--terminal-scrollbar", "rgba(122, 154, 170, 0.18)"),
    scrollbarSliderHoverBackground: read("--terminal-scrollbar-hover", "rgba(122, 154, 170, 0.26)"),
    scrollbarSliderActiveBackground: read(
      "--terminal-scrollbar-active",
      "rgba(122, 154, 170, 0.34)",
    ),
    black: read("--terminal-ansi-black", "#182129"),
    red: read("--terminal-ansi-red", "#d07c88"),
    green: read("--terminal-ansi-green", "#79b18f"),
    yellow: read("--terminal-ansi-yellow", "#d2ae68"),
    blue: read("--terminal-ansi-blue", "#7a9aaa"),
    magenta: read("--terminal-ansi-magenta", "#b39ac0"),
    cyan: read("--terminal-ansi-cyan", "#7eb5bc"),
    white: read("--terminal-ansi-white", "#d9e4ea"),
    brightBlack: read("--terminal-ansi-bright-black", "#728694"),
    brightRed: read("--terminal-ansi-bright-red", "#e39aa4"),
    brightGreen: read("--terminal-ansi-bright-green", "#98c7ab"),
    brightYellow: read("--terminal-ansi-bright-yellow", "#e4c78d"),
    brightBlue: read("--terminal-ansi-bright-blue", "#a9c3d1"),
    brightMagenta: read("--terminal-ansi-bright-magenta", "#cdb8d7"),
    brightCyan: read("--terminal-ansi-bright-cyan", "#9dd1d7"),
    brightWhite: read("--terminal-ansi-bright-white", "#f4f8fa"),
  };
}
...
function TerminalViewport({
  ...
  return <div ref={containerRef} className="h-full w-full overflow-hidden rounded-sm" />;
}
        ...
        <div className={`flex h-full min-h-0 ${hasTerminalSidebar ? "gap-1.5" : ""}`}>
          ...
          {hasTerminalSidebar && (
            <aside className="flex w-36 min-w-36 flex-col border border-border/70 bg-muted/10">
              <div className="flex h-6 items-stretch justify-end border-b border-border/70">
