import { KeybindingCommand, KeybindingRule, KeybindingsConfig } from "@studio/contracts";
    ...
    Layer.provideMerge(
      Layer.effect(
        ...
        Effect.gen(function* () {
          ...
          const dir = yield* fs.makeTempDirectoryScoped({ prefix: "studio-server-config-test-" });
