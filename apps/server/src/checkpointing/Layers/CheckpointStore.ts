...
import { CheckpointRef } from "@studio/contracts";
  ...
  const captureCheckpoint: CheckpointStoreShape["captureCheckpoint"] = (input) =>
    Effect.gen(function* () {
      ...
      yield* Effect.acquireUseRelease(
        fs.makeTempDirectory({ prefix: "studio-fs-checkpoint-" }),
        (tempDir) =>
          Effect.gen(function* () {
            ...
            const commitEnv: NodeJS.ProcessEnv = {
              ...
              GIT_AUTHOR_NAME: "Studio by HarnessGG",
              GIT_AUTHOR_EMAIL: "studio@users.noreply.github.com",
              GIT_COMMITTER_NAME: "Studio by HarnessGG",
              GIT_COMMITTER_EMAIL: "studio@users.noreply.github.com",
            };
            ...
            const message = `studio checkpoint ref=${input.checkpointRef}`;
