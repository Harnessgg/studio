...
import { makeDrainableWorker } from "@studio/shared/DrainableWorker";
...
const STRICT_PROVIDER_LIFECYCLE_GUARD = process.env.STUDIO_STRICT_PROVIDER_LIFECYCLE_GUARD !== "0";
